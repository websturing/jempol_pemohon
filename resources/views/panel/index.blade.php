...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet"
        href="{{url('public/starAdmin/assets/vendors/iconfonts/mdi/css/materialdesignicons.min.css')}}">
    ...
    <link rel="stylesheet"
        href="{{url('public/starAdmin/assets/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css')}}">
                            ...
                            <a href="#" class="nav-link">
                                <div class="profile-image">
                                    <img class="img-xs rounded-circle"
                                        src="{{url('public/starAdmin/assets/images/faces-clipart/pic-1.png')}}"
                                        alt="profile image">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{url('/permohonan/track')}}">Track</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
